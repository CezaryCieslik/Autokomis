...
public class Marian {
    ...
    public void marianRepair(Player player, Car car){
        ...
        if(this.brakes.equals("Efficient")){
            ...
            Double BRAKES_REPAIR_PRICE = 300.0;
            if(this.brakes.equals("Broken") && car.brand.equals("Toyota")){
                if(chance <= 10){
                    System.out.println("Marian is not able to repair it.");
                }else {
        ...
        Double CHASSIS_REPAIR_PRICE = 700.0;
        ...
        Double ENGINE_REPAIR_PRICE = 6000.0;
        ...
        Double BODY_REPAIR_PRICE = 2000.0;
        ...
        Double GEARBOX_REPAIR_PRICE = 1000.0;
