...
public class Adrian {
    ...
    public void adrianRepair(Player player, Car car) {
        ...
        if (this.brakes.equals("Efficient")) {
            ...
            Double BRAKES_REPAIR_PRICE = 100.0;
            if (this.brakes.equals("Broken") && car.brand.equals("Toyota")) {
                if (chance <= 20) {
                    System.out.println("Adrian is not able to repair it.");
                } else {
        ...
        Double CHASSIS_REPAIR_PRICE = 500.0;
        ...
        Double ENGINE_REPAIR_PRICE = 4000.0;
        ...
        Double BODY_REPAIR_PRICE = 1500.0;
        ...
        Double GEARBOX_REPAIR_PRICE = 800.0;
